 ...
 * 
 */
public class SimpleTestDocIndexRunCPE extends Thread {
  /**
   * The CPE instance.
   */
   ...
   */
  public SimpleTestDocIndexRunCPE(String args[]) throws Exception {
    mStartTime = System.currentTimeMillis();
    if(args.length==0){
    	args=new String[1];
    	args[0]=new String("src/main/resources/CpeTestDescriptor.xml");
    }
  ...
  public static void main(String[] args) throws Exception {
    new SimpleTestDocIndexRunCPE(args);
  }
