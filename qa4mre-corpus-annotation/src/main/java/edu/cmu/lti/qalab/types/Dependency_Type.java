...
public class Dependency_Type extends Annotation_Type {
  ...
  /** @generated */ 
  public String getGovernor(int addr) {
        if (featOkTst && casFeat_governor == null)
      jcas.throwFeatMissing("governor", "edu.cmu.lti.qalab.types.Dependency");
    return ll_cas.ll_getStringValue(addr, casFeatCode_governor);
  }
  /** @generated */    
  public void setGovernor(int addr, String v) {
        if (featOkTst && casFeat_governor == null)
      jcas.throwFeatMissing("governor", "edu.cmu.lti.qalab.types.Dependency");
    ll_cas.ll_setStringValue(addr, casFeatCode_governor, v);}
  ...
  /** @generated */ 
  public String getDependent(int addr) {
        if (featOkTst && casFeat_dependent == null)
      jcas.throwFeatMissing("dependent", "edu.cmu.lti.qalab.types.Dependency");
    return ll_cas.ll_getStringValue(addr, casFeatCode_dependent);
  }
  /** @generated */    
  public void setDependent(int addr, String v) {
        if (featOkTst && casFeat_dependent == null)
      jcas.throwFeatMissing("dependent", "edu.cmu.lti.qalab.types.Dependency");
    ll_cas.ll_setStringValue(addr, casFeatCode_dependent, v);}
  ...
  public Dependency_Type(JCas jcas, Type casType) {
    ...
    casFeat_governor = jcas.getRequiredFeatureDE(casType, "governor", "uima.cas.String", featOkTst);
    casFeatCode_governor  = (null == casFeat_governor) ? JCas.INVALID_FEATURE_CODE : ((FeatureImpl)casFeat_governor).getCode();

 
    casFeat_dependent = jcas.getRequiredFeatureDE(casType, "dependent", "uima.cas.String", featOkTst);
